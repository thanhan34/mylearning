                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {futureExams.map((info, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">{info.target}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{info.className}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{info.teacherName}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{info.examLocation}</td>
