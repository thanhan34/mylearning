...
const SystemStats = () => {
  ...
  return (
    <div className="space-y-8">
        ...
        {isLoading ? (
          ...
          <>
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="text-3xl font-bold text-[#fc5d01]">{stats.submissionCount}</div>
              <div className="mt-2 text-sm text-gray-600">Tổng số bài tập đã nộp</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="mt-2 text-sm text-gray-600">Tỷ lệ hoàn thành trung bình</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="mt-2 text-sm text-gray-600">Phần trăm học viên trong hệ thống</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="mt-2 text-sm text-gray-600">Số bài tập trung bình mỗi học viên</div>
            </div>
          </>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {isLoading ? (
          ...
          <>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-lg font-semibold text-[#fc5d01] mb-6">Phân bố người dùng</h3>
      ...
      {/* Class Progress */}
      <div className="bg-white p-6 rounded-xl shadow-md">
        <h3 className="text-lg font-semibold text-[#fc5d01] mb-6">Tiến độ các lớp học</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-lg font-semibold text-[#fc5d01] mb-6">Bài tập hàng ngày</h3>
          <DailyHome />
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-lg font-semibold text-[#fc5d01] mb-6">Mục tiêu hàng ngày</h3>
          <DailyTargetTable />
        </div>
      </div>
    </div>
