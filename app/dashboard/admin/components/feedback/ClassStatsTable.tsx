...
export default function ClassStatsTable({ classStats }: ClassStatsTableProps) {
  return (
            ...
            {classStats.length === 0 ? (
              ...
              classStats.map(classData => (
                <tr key={classData.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{classData.totalSubmissions}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{classData.submissionsWithFeedback}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
