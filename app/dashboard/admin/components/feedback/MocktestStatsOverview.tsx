...
interface MocktestStatsOverviewProps {
...
export default function MocktestStatsOverview({ 
  totalMocktests, 
  mocktestsWithFeedback, 
  mocktestsWithoutFeedback, 
  feedbackPercentage 
}: MocktestStatsOverviewProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <div className="text-3xl font-bold text-[#fc5d01]">{totalMocktests}</div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <div className="text-3xl font-bold text-[#fc5d01]">{mocktestsWithFeedback}</div>
        <div className="mt-2 text-sm text-gray-600">
          {feedbackPercentage}% tổng số mocktest
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <div className="text-3xl font-bold text-[#fc5d01]">{mocktestsWithoutFeedback}</div>
        <div className="mt-2 text-sm text-gray-600">
          {totalMocktests > 0 ? (100 - feedbackPercentage) : 0}% tổng số mocktest
        </div>
      </div>
    </div>
  );
