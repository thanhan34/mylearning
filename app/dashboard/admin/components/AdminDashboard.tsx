...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 p-3 sm:p-6 animate-fadeIn">
      {/* Overview Stats */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-gradient-to-br from-white to-[#fedac2]/10 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="bg-gradient-to-br from-white to-[#fedac2]/10 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
        <h3 className="text-lg sm:text-xl font-semibold text-[#fc5d01] mb-4 sm:mb-6 flex items-center">
